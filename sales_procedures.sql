CREATE DATABASE veebipoodMihhailenko;
use veebipoodMihhailenko;
...
('talvejope',    1, 5, 2024, 120.00),
('kerge jope',   3, 5, 2022, 70.00);
...
WHERE category_id=2;
--  protseduur mis lisab INSERT andmeid tabelisse brands
...
-- protseduur mis otsib 1 tähte järgi brandinimed
...
-- protseduur mis uuendab (UPDATE) brandinimi id järgi
